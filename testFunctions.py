...
# All code that have to do with responses goes here
        ...
        # tell me the time
            ...
            webbrowser.open_new_tab(
                "https://music.youtube.com/playlist?list=PLCRCtthPFnxGLZdOS84qpAihJFdN1t7BH")
            ...
            webbrowser.open(
                "https://app.milanote.com/1KRLhg12dNeX0G/projects?p=YvGGoS8AKhM")
            ...
            webbrowser.open(
                'https://analytics.google.com/analytics/web/#/report-home/a174200105w241674239p225387149')
            speak(
...
# all code for changing and checking the content of list goes here
        ...
        # all aplication opennning code goes here
            ...
            print("openning.....")
            subprocess.call(
                "C:\\Users\KINGSLEY-DURU\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe")
            ...
            print("openning.....")
            subprocess.call(
                "C:\\Users\\KINGSLEY-DURU\\AppData\\Local\\JetBrains\\Toolbox\\apps\\Rider\\ch-0\\213.6775.4\\bin\\rider64.exe")
        ...
        nebulaWords = tk.Label(app, text=values["nebula"])

        nebulaWords.grid(row=0, column=0)

        yourWords = tk.Label(app, text=values["you"])
        yourWords.grid(row=1, column=0)
